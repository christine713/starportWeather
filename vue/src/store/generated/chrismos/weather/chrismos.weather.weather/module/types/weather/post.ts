...
const baseweatherPost: object = { creator: "", id: 0, title: "", body: "" };

export const weatherPost = {
  encode(message: weatherPost, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): weatherPost {
    ...
    const message = { ...baseweatherPost } as weatherPost;
